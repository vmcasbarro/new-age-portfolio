My portfolio was created using a start bootstrap template, which was an excellent starting point and highly recommendable. I've done a lot of tweaking to fit my needs and goals, but below is the original readme info which includes where to find the template yourself!
